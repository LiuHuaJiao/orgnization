...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/LiuHuaJiao/orgnization"
  ...
  s.source       = { :git => "https://github.com/LiuHuaJiao/orgnization.git", :tag => s.version.to_s }
  ...
  s.source_files  = "MainProject/MainProject/**/*.{h,m}"
